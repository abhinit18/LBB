...
myApp.config(['$stateProvider', '$urlRouterProvider',
    ...
    $stateProvider
        ...
        .state('layout1.mapping', {
            url: "/mapping",
            templateUrl: "app/components/flickrMap/mapImage.html",
            controller: 'mapImageController'
        })
        .state('layout1.pinterest', {
            url: "/pinterest",
            templateUrl: "app/components/pinterest/pinterest.html",
            controller: 'pinterestController'
        })
        .state('layout1.task', {
            url: "/task",
            templateUrl: "app/components/taskQuestion/task.html",
